...
# # Remove the feature with the lowest model coefficient (Instruction 1)
...
# # Remove the 2 features with the lowest model coefficients (Instruction 2)
...
# Only keep the feature with the highest coefficient (Instruction 3)
