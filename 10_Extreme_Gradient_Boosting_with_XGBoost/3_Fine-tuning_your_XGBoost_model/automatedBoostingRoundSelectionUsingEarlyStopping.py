...
cv_results = pd.DataFrame(xgb.cv(dtrain=housing_dmatrix, params=params, metrics="rmse", early_stopping_rounds=10, num_boost_round=50, seed=123, nfold=3, as_pandas=True))
