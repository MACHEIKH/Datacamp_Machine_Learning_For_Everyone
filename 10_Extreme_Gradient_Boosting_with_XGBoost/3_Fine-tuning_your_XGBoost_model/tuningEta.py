...
for curr_val in eta_vals:
    ...
    cv_results = pd.DataFrame(xgb.cv(dtrain=housing_dmatrix, params=params, metrics="rmse", early_stopping_rounds=5, num_boost_round=10, seed=123, nfold=3, as_pandas=True))
