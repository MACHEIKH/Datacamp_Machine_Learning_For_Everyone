...
# Print out the old estimator, notice which hyperparameter is badly set (Instruction 1)
print(rf_clf_old)
...
# Create a new random forest classifier with better hyperparamaters (Instruction 2)
rf_clf_new = RandomForestClassifier(n_estimators=500)

# Fit this to the data and obtain predictions
rf_new_predictions = rf_clf_new.fit(X_train, y_train).predict(X_test)

# Assess the new model (using new predictions!) (Instruction 3)
