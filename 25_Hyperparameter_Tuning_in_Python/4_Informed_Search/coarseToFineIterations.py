...
# Use the provided function to visualize the first results (Instruction 1)
# visualize_first()

# Create some combinations lists & combine: (Instruction 2)
max_depth_list = list(range(1,21))
learn_rate_list = np.linspace(0.001,1,50)

# Call the function to visualize the second results (Instruction 3)
visualize_second()
