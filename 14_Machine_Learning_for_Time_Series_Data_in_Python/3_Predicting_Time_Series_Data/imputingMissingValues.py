...
# # Create a function we'll use to interpolate and plot (Instruction 1)
...
# # Interpolate using the latest non-missing value (Instruction 2)
# interpolation_type = 'zero'
# interpolate_and_plot(prices, interpolation_type)


# # Interpolate linearly (Instruction 3)
# interpolation_type = 'linear'
# interpolate_and_plot(prices, interpolation_type)


# Interpolate with a quadratic function (Instruction 4)
